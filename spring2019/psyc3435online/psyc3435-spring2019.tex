...
\hypersetup{
 pdfauthor={},
 pdftitle={PSYC 3435: Principles of Research for the Behavorial Sciences (online)},
 pdfkeywords={},
 pdfsubject={},
...
\item Exam 2, due Sunday, Mar 31
\item Exam 3, due Sunday, Apr 21
\end{itemize}

\subsection*{Unit quizzes (20\% of grade)}
\label{sec:org7f0482b}
...
7 & Experiments: classic designs & Sunday, Mar 24\\
 & \textbf{Exam 2} & \textbf{Sunday, Mar 31}\\
8 & Non-experiments: survey and correlational designs & Sunday, Apr 7\\
9 & Non-experiments: quasi-experiments and developmental designs & Sunday, Apr 14\\
 & \textbf{Exam 3} & \textbf{Sunday, Apr 21}\\
\end{tabular}
\end{center}
\end{document}