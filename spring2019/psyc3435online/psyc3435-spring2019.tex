...
\date{Spring 2019}
\title{PSYC 3435: Principles of Research for the Behavioral Sciences (online)}
\hypersetup{
 pdfauthor={},
 pdftitle={PSYC 3435: Principles of Research for the Behavioral Sciences (online)},
 pdfkeywords={},
 pdfsubject={},
...
\begin{itemize}
\item Exam 1, due Sunday, Feb 24
\item Exam 2, due Sunday, Apr 7
\item Exam 3, due Sunday, Apr 28
\end{itemize}

\subsection*{Unit quizzes (20\% of grade)}
\label{sec:orgd0c1d94}
...
\begin{itemize}
\item Lab 1 – APA formatting (10 points), due Friday, Feb 1
\item Lab 2.1 – Correlational design, data collection (10 points), due Friday, Feb 8
\item Lab 2.2 – Correlational design, analysis and report (20 points), due Friday, Feb 22
\item Lab 3.1 – Independent groups design, data collection (10 points), due Friday, Mar 1
\item Lab 3.2 – Independent groups design, analysis and report (20 points), due Friday, Mar 22
\item Lab 4.1 – Factorial design, data collection (10 points), due Friday, Mar 29
\item Lab 4.2 – Factorial design, analysis and report (20 points), due Friday, Apr 12
\end{itemize}

\section*{Course Communication}
\label{sec:org0dc3698}
...
\label{sec:org9821a09}

\begin{center}
\begin{tabular}{rll}
Unit & Topic & Due date\\
\hline
0 & Statistics review & Sunday, Jan 20\\
1 & Knowing in psychological science & Sunday, Jan 27\\
2 & Reading the literature / APA style & Sunday, Feb 3\\
3 & Basic research methods & Sunday, Feb 10\\
4 & Ethics in psychological science & Sunday, Feb 17\\
 & \textbf{Exam 1} & \textbf{Sunday, Feb 24}\\
5 & Experiments: selecting and manipulating variables & Sunday, Mar 3\\
6 & Experiments: sampling methods & Sunday, Mar 10\\
7 & Experiments: classic designs & Sunday, Mar 31\\
 & \textbf{Exam 2} & \textbf{Sunday, Apr 7}\\
8 & Non-experiments: survey and correlational designs & Sunday, Apr 14\\
9 & Non-experiments: quasi-experiments and developmental designs & Sunday, Apr 21\\
 & \textbf{Exam 3} & \textbf{Sunday, Apr 28}\\
\end{tabular}
\end{center}
\end{document}