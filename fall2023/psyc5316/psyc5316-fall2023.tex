...
\label{sec:orgef13900}

\subsection*{Academic Integrity Statement}
\label{sec:org8197654}
...
\section*{Student Success Statement}
\label{sec:orgfd53eab}

Tarleton State University is committed to complying with the Americans with Disabilities Act (\url{https://www.ada.gov}) and other applicable laws. If you are a student with a disability seeking accommodation for this course, please contact the Office of Student Accessibility Services at 254.968.5491, studentaccessibilityservices@tarleton.edu, or visit \url{https://www.tarleton.edu/sas/}.  

\textbf{Note:  any changes to this syllabus will be communicated to you by the instructor!}

\section*{Tentative schedule}
\label{sec:org57f318a}
