...
You will complete four lab activities throughout the semester. With the exception of the first lab (how to use R), the labs will each take four weeks, following the same basic schedule:
